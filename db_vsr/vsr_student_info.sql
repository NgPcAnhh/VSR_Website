...
CREATE TABLE `student_info` (
  `current_band` decimal(3,1) NOT NULL,
  `total_time` int NOT NULL,
  `nationality` varchar(100) NOT NULL,
  `native_language` varchar(100) NOT NULL,
  `type_of_study` varchar(50) NOT NULL,
  `english_experience_years` int DEFAULT NULL,
  `age` int DEFAULT NULL,
  `target_band` decimal(3,1) NOT NULL,
  CONSTRAINT `student_info_chk_1` CHECK ((`english_experience_years` >= 0)),
  CONSTRAINT `student_info_chk_2` CHECK ((`age` >= 0))
...
INSERT INTO `student_info` VALUES (6.0,400,'Vietnam','Vietnamese','self-study',15,20,7.3);
